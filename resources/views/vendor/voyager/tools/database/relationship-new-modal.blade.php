		    ...
		    <div class="model-content">
		        ...
		        <div class="modal-body">
			        <div class="row">
				        ...
				        @else
				        	<div class="col-md-12">
				        		<h5><i class="voyager-rum-1"></i> Easy there</h5>
				        		<p class="relationship-warn"> Before create</p>
				        	</div>
				        @endif
			    ...
			    <div class="modal-footer">
			    	<div class="relationship-btn-container">
	                    ...
	                    @if(isset($dataType->id))
	                    	<button class="btn btn-danger btn-relationship"><i class="voyager-plus"></i> <span>Add New</span></button>
	                	@endif
	                </div>
			    </div>
		    </div>
